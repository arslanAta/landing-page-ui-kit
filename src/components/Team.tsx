                    ...
                    <div className="w-full px-6">
                        ...
                        <div className="mt-10 grid grid-cols-1 lg:grid-cols-3 gap-24 ">
                            <div className="min-h-[450px] col-span-1 rounded-3xl bg-white">
                                <div className="h-3/5">
                                    <img src={`${path}./img/profile1.png`} alt="" className="w-full h-full" />
                                </div>
                            ...
                            <div className="min-h-[450px] col-span-1 rounded-3xl bg-white">
                                <div className="h-3/5">
                                    <img src={`${path}./img/profile2.png`} alt="" className="w-full h-full" />
                                </div>
                                <div className="h-1/5 pt-6">
                            ...
                            <div className="min-h-[450px] col-span-1 rounded-3xl bg-white">
                                <div className="h-3/5">
                                    <img src={`${path}./img/profile3.png`} alt="" className="w-full h-full" />
                                </div>
                                <div className="h-1/5 pt-6">
